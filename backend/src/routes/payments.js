...
const { merchantAuth, auth, customerAuth, requireFullVerification } = require('../middleware/auth');
...
router.post('/mobile-money', auth, requireFullVerification, async (req, res) => {
  try {
